...
export function ExamInfoCard({ exam, fontScale = 1.0, compact = false }: ExamInfoCardProps) {
    ...
    <>
      ...
      <div className="text-center">
        <div
          ...
          style={{ fontSize: `${(compact ? 1.1 : 1.3) * fontScale}vw`, marginBottom: `${0.5 * fontScale}vh` }}
        >
          시험 시간
        </div>
        <div
          className="font-bold tabular-nums"
          style={{ fontSize: `${(compact ? 2.5 : 3.5) * fontScale}vw` }}
        >
        ...
        <div className="text-center">
          ...
          {canEarlyExit ? (
            <div
              ...
              style={{ fontSize: `${(compact ? 2 : 2.5) * fontScale}vw` }}
            >
              퇴실 가능
            </div>
          ) : (
            <div
              className="font-bold tabular-nums"
              style={{ fontSize: `${(compact ? 2.2 : 3) * fontScale}vw` }}
            >
    ...
    return (
      <Card className="bg-card/50 backdrop-blur overflow-hidden">
        <CardContent
          ...
          style={{ padding: `${1.2 * fontScale}vw`, gap: `${1.5 * fontScale}vh` }}
        >
          {content}
        </CardContent>
      </Card>
